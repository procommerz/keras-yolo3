...
def _main():
    ...
    annotation_path = 'model_data/training-usbase_train.txt'
    log_dir = 'logs/000/'
    ...
    #model = create_tiny_model(input_shape, anchors, num_classes, freeze_body=2, load_pretrained=True, weights_path=start_checkpoint) # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    if load_pretrained:
        print("LOADING MODEL: %s as the start checkpoint" % (weights_path))
